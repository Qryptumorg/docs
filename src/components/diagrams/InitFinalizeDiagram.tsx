export default function InitFinalizeDiagram() {
  return (
    <div className="diagram-container">
      <svg viewBox="0 0 680 340" width="100%" style={{ fontFamily: "ui-sans-serif, system-ui, sans-serif" }}>
        ...
        <text x="100" y="62" textAnchor="middle" fontSize="9.5" fill="#374151" fontWeight="600">Step 1: Compute initHash</text>
        ...
        <text x="100" y="122" textAnchor="middle" fontSize="9.5" fill="#d1d5db" fontWeight="600">TX: initTransfer(hash)</text>
        ...
        <text x="100" y="222" textAnchor="middle" fontSize="9.5" fill="#d1d5db" fontWeight="600">TX: finalizeTransfer(</text>
